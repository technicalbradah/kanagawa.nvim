...
return {
  ...
  ---@param palette PaletteColors
  ---@return ThemeColors
  jdragon = function(palette)
    return {
      ui = {
        fg = palette.jdragonWhite,
        fg_dim = palette.oldWhite,
        fg_reverse = palette.waveBlue1,

        bg_dim = palette.jdragonBlack1,
        bg_gutter = palette.jdragonBlack4,

        bg_m3 = palette.jdragonBlack0,
        bg_m2 = palette.jdragonBlack1,
        bg_m1 = palette.jdragonBlack2,
        bg = palette.jdragonBlack3,
        bg_p1 = palette.jdragonBlack4,
        bg_p2 = palette.jdragonBlack5,

        special = palette.jdragonGray3,
        whitespace = palette.jdragonBlack6,
        nontext = palette.jdragonBlack6,
        ...
        float = {
          fg = palette.oldWhite,
          bg = palette.jdragonBlack0,
          fg_border = palette.sumiInk6,
          bg_border = palette.jdragonBlack0,
        },
      },
      syn = {
        string = palette.jdragonGreen2,
        variable = "none",
        number = palette.jdragonPink,
        constant = palette.jdragonOrange,
        identifier = palette.jdragonYellow,
        parameter = palette.jdragonGray,
        fun = palette.jdragonBlue2,
        statement = palette.jdragonViolet,
        keyword = palette.jdragonViolet,
        operator = palette.jdragonRed,
        preproc = palette.jdragonRed,
        type = palette.jdragonAqua,
        regex = palette.jdragonRed,
        deprecated = palette.katanaGray,
        punct = palette.jdragonGray2,
        comment = palette.jdragonAsh,
        special1 = palette.jdragonTeal,
        special2 = palette.jdragonRed,
        special3 = palette.jdragonRed,
      },
      diag = {
        error = palette.samuraiRed,
        ok = palette.springGreen,
        warning = palette.roninYellow,
        info = palette.jdragonBlue,
        hint = palette.waveAqua1,
      },
      diff = {
        add = palette.winterGreen,
      ...
      term = {
        palette.jdragonBlack0, -- black
        palette.jdragonRed, -- red
        palette.jdragonGreen2, -- green
        palette.jdragonYellow, -- yellow
        palette.jdragonBlue2, -- blue
        palette.jdragonPink, -- magenta
        palette.jdragonAqua, -- cyan
        palette.oldWhite, -- white
        palette.jdragonGray, -- bright black
        palette.waveRed, -- bright red
        palette.jdragonGreen, -- bright green
        palette.carpYellow, -- bright yellow
        palette.springBlue, -- bright blue
        palette.springViolet1, -- bright magenta
        palette.waveAqua2, -- bright cyan
        palette.jdragonWhite, -- bright white
        palette.jdragonOrange, -- extended color 1
        palette.jdragonOrange2, -- extended color 2
      },
    }
  end,
  ---@param palette PaletteColors
