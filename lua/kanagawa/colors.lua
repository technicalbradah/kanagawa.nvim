...
local palette = {
  ...
  jdragonBlack0 = "#0d0c0c",
  jdragonBlack1 = "#12120f",
  jdragonBlack2 = "#1D1C19",
  jdragonBlack3 = "#181616",
  jdragonBlack4 = "#282828", --done?
  jdragonBlack5 = "#393836", --done
  jdragonBlack6 = "#625e5a",

  jdragonWhite = "#dcd7ba", --done
  jdragonGreen = "#87a987",
  jdragonGreen2 = "#8a9a7b", --done
  jdragonPink = "#a292a3", --done
  jdragonOrange = "#b6927b",
  jdragonOrange2 = "#b98d7b",
  jdragonGray = "#a6a69c", --done
  jdragonGray2 = "#9e9b93", --done
  jdragonGray3 = "#7a8382",
  jdragonBlue2 = "#859fac", --done
  jdragonViolet = "#a292a3", --done
  jdragonRed = "#c4746e", --done
  jdragonAqua = "#8ea49e", --done
  jdragonAsh = "#727169", --done
  jdragonTeal = "#c4b28a", --done
  jdragonYellow = "#c4746e", --done
